...
<div class="attendance-detail">
    ...
    <form action="{{ route('admin.attendance.update', $attendance?->id ?? 0 ) }}" method="POST" class="attendance-form">
        ...
        <div class="form-group">
            <label>出勤・退勤</label>
            <input type="time" name="clock_in_at" value="{{ old('clock_in_at', $attendance?->clock_in_hm) }}">
            〜
            <input type="time" name="clock_out_at" value="{{ old('clock_out_at', $attendance?->clock_out_hm) }}">
